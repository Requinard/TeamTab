...
public class NetworkMessage {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof NetworkMessage) {
            ...
            NetworkRequest newReq = new NetworkRequest(message);
            NetworkRequest oldReq = new NetworkRequest(this);

            return oldReq.getUrl().equals(newReq.getUrl()) && this.getSender().equals(message.getSender());
        }
        return false;
    }
