...
public class MediatorIntergrationTest {
    ...
    public void playerGetUsername() throws InterruptedException {
        ...
        assertEquals("Vito", clientGame.getPlayer("Vito").getUsername());
        Thread.sleep(2000);
    }
    ...
    public void playerGetIP() throws InterruptedException {
        ...
        assertEquals("127.0.0.1", clientGame.getPlayer("Vito").getIp());
        Thread.sleep(2000);
    }
    ...
    public void playerGetPanels() throws InterruptedException {
        ...
        assertEquals(1, clientGame.getPlayer("Vito").getPanels().size());
        Thread.sleep(2000);
    }
